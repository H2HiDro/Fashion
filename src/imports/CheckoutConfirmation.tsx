...
import svgPaths from "./svg-xkl4xpgrq5";
...
export default function CheckoutConfirmation() {
  return (
    <div className="bg-white relative size-full" data-name="Checkout/Confirmation">
      <p className="absolute font-['Playfair_Display:Medium',sans-serif] font-medium leading-[1.3] left-[42px] text-[#3e3e3e] text-[76px] top-[174px] uppercase whitespace-nowrap">Confirmation</p>
        ...
        <div className="content-stretch flex items-start justify-between leading-[1.35] not-italic relative shrink-0 text-[20px] w-full">
          ...
          <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 uppercase w-[113px]">
            <div className="content-stretch flex flex-col font-['Lato:Regular',sans-serif] gap-[12px] items-start relative shrink-0 w-full">
              ...
              <p className="relative shrink-0 text-[#757575] w-full">IDR 39.000</p>
            </div>
            <p className="font-['Lato:SemiBold',sans-serif] relative shrink-0 text-[#3e3e3e] w-full">IDR 289.000</p>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col justify-center size-full">
          <div className="content-stretch flex flex-col gap-[8px] items-start justify-center relative">
                ...
                <div className="overflow-clip relative shrink-0 size-[16px]" data-name="heroicons-solid/credit-card">
                  <div className="absolute inset-[15.63%_6.25%]" data-name="Subtract">
                    <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 11">
                      <g id="Subtract">
                        <path d={svgPaths.p2b96fd00} fill="var(--fill-0, #8B4513)" />
                        <path clipRule="evenodd" d={svgPaths.p11707200} fill="var(--fill-0, #8B4513)" fillRule="evenodd" />
                      </g>
                    </svg>
                  </div>
                </div>
            ...
            <div className="content-stretch flex gap-[32px] items-center leading-[1.35] not-italic relative shrink-0">
              <Helper1 text="Step 1" text1="Personal Info" />
              <Helper1 text="Step 2" text1="Shipping Delivery" />
      ...
      <div className="absolute content-stretch flex items-center justify-between left-[42px] top-[451px] w-[756px]">
        <div className="content-stretch flex flex-col font-['Lato:Regular',sans-serif] gap-[4px] items-start leading-[1.35] not-italic relative shrink-0 text-[20px]">
          <p className="min-w-full relative shrink-0 text-[#757575] w-[min-content]">Order Number</p>
          <p className="relative shrink-0 text-[#3e3e3e] uppercase whitespace-nowrap">12345ASDFGHJ</p>
        </div>
        <div className="bg-[#fbe0e0] content-stretch flex items-center justify-center px-[12px] py-[8px] relative rounded-[100px] shrink-0">
          <div aria-hidden="true" className="absolute border border-[#ecc0c0] border-solid inset-0 pointer-events-none rounded-[100px]" />
          <p className="font-['Lato:Regular',sans-serif] leading-[1.35] not-italic relative shrink-0 text-[#cd0909] text-[12px] whitespace-nowrap">Waiting For Payment</p>
        </div>
      </div>
      <div className="absolute content-stretch flex flex-col font-['Lato:Regular',sans-serif] gap-[4px] items-start leading-[1.35] left-[42px] not-italic text-[20px] top-[549px] w-[756px]">
        <p className="relative shrink-0 text-[#757575] whitespace-nowrap">Payment Information</p>
        <p className="min-w-full relative shrink-0 text-[#3e3e3e] w-[min-content]">Upon completing a purchase, you will receive a payment confirmation email. This email will contain essential information about the items you have purchased and the total amount that needs to be paid.</p>
      </div>
      <div className="absolute bg-[#8b4513] left-[calc(12.5%+68px)] top-[725px] w-[315px]" data-name="Button">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[8px] items-center p-[16px] relative w-full">
            <p className="flex-[1_0_0] font-['Lato:Regular',sans-serif] leading-[normal] min-h-px min-w-px not-italic relative text-[16px] text-center text-white tracking-[1.6px] uppercase whitespace-nowrap">i already pay</p>
          </div>
        </div>
      </div>
    </div>
